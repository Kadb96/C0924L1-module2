package bai_tap.luyen_tap_su_dung_linkedlist_trong_java_collection_framework.controller;

import bai_tap.service.ProductServiceLinkedList;
...
public class ProductController {
    public static void showProductMenu() {
        ...
        ProductServiceLinkedList productService = new ProductServiceLinkedList();
        while (true) {
